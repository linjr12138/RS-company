...
public class SwaggerConfig {
    ...
    public Docket createDocket() {
        ...
        accessTokenBuilder.name("token").description("程序员自测的时候动态传输AccessToken 入口")
        ...
        return new Docket(DocumentationType.SWAGGER_2)
                .apiInfo(apiInfo())
                .select()
                .apis(RequestHandlerSelectors.basePackage("com.linjr.controller"))
    ...
    private ApiInfo apiInfo() {
        return new ApiInfoBuilder().title("RS后台权限管理系统实战")
                .description("RS后台权限管理系统后端接口文档")
                .termsOfServiceUrl("")
                .version("2.0")
                .build();
    }
