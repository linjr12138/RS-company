package com.linjr.exception.code;
...
public enum BaseResponseCode implements ResponseCodeInterface {
    ...
    IMPORT_ERROR(40000012, "导入失败"),
    FORMAT_ERROR(40000013, "导入格式不正确"),
    EXECLEMPTY_ERROR(40000014, "EXCEL表为空"),
    IMPORTBASEPRODUCTEMPTY_ERROR(40000015, "导入的货品不存在货品资料中"),
    IMPORTBASECLIENTEMPTY_ERROR(40000016, "导入的店铺不存在于客户资料中"),
    REPECTSHOP_ERROR(40000017, "目前只能导入一家"),
    SAVEORDER_ERROR(40000018, "保存失败"),
    ...
    ACCOUNT_LOCK_TIP(4010001, "该账号被锁定,请联系系统管理员"),
